...
module.exports = {
    ...
    async execute(client, message, args) {
        ...
        if (cooldown) {
            ...
            let rol = message.guild.roles.cache.find(r => r.name === "x6tence Abonado");

            if (!message.member.roles.cache.has(rol.id)) {
                message.channel.send(' Lo siento, no eres abonado de x6tence, no puedes usar este comando')
                return;
            }
            ...
            const embed = new Discord.MessageEmbed()
                ...
                .setDescription(usuario + ", gracias por ser abonado del mejor club del mundo, es por eso que te has ganado " + random + ' puntos ' + " extra ")
                .setColor("ORANGE")
